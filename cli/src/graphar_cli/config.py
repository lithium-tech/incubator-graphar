...
class Edge(BaseModel):
    ...
    src_type: str
    src_prop: str
    src_edge_prop: str = None
    # Field(default_factory=lambda validate_data: validate_data["src_prop"]) # pd2.10
    dst_type: str
    dst_prop: str
    dst_edge_prop: str = None
    # Field(default_factory=lambda validate_data: validate_data["dst_prop"]) # pd2.10
    chunk_size: Optional[int] = None
    validate_level: Optional[Literal["no", "weak", "strong"]] = None
